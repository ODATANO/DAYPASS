 ...
 *     the `passport.Partners` registry). `req.user.id = DID`.
 ...
 * dataspace does this with verifiable credentials; we mirror its shape. A
 * CIP-30 signData wallet login can harden this later (VerifyDataSignature).
 */
const { SELECT } = cds.ql;
